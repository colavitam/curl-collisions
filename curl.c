...
static void transform(int8_t *state, int8_t *temp, int rounds) {
...
void absorb_rounds(const int8_t *input, int32_t ioffset, int32_t ilength, int8_t *state, int8_t *temp, int rounds) {
    do {
